...
SELECT * FROM parquet.`/Volumes/dev/mahesh/raw/part-00000-7951754c-3166-4cb7-8227-a5760c654c14-c000.snappy.parquet`

-- COMMAND ----------

create table dev.mahesh.customer_parquet

-- COMMAND ----------

-- MAGIC %python
-- MAGIC df=spark.read.parquet("/Volumes/dev/mahesh/raw/part-00000-7951754c-3166-4cb7-8227-a5760c654c14-c000.snappy.parquet")
